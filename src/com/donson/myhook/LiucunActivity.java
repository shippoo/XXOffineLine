...
//		getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
		...
		boolean isNew = SPrefHookUtil.getTaskInt(this, SPrefHookUtil.KEY_TASK_PLAN_TYPE, SPrefHookUtil.D_TASK_PLAN_TYPE)==SPrefHookUtil.D_TASK_PLAN_TYPE_NEW?true:false;
	...
	public void onClick(View v) {
		...
		case R.id.rl_run_retain:
			if(cbRunNewTask.isChecked()){
				...
				SPrefHookUtil.putTaskInt(LiucunActivity.this, SPrefHookUtil.KEY_TASK_PLAN_TYPE,SPrefHookUtil.D_TASK_PLAN_TYPE_RETAIN);
			}else {
				cbRunNewTask.setChecked(true);
				SPrefHookUtil.putTaskInt(LiucunActivity.this, SPrefHookUtil.KEY_TASK_PLAN_TYPE,SPrefHookUtil.D_TASK_PLAN_TYPE_NEW);
			}
			break;
		default:
			break;
